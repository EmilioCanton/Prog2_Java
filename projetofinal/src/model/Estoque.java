...
public class Estoque {
    ...
    /*
    public void criaEstoquePadrao(Catalogo c){
        for(Filme f: c.getCatalogo()){
            estoque.put(f, 3);
        }
    }*/
    ...
    public void originalEstoque(){
        ...
        estoque.put(filme, 3);
        filme = new Filme("Kimi no na wa","Romance","52.00","2016");
        estoque.put(filme, 3);
        ...
        estoque.put(filme, 3);
        filme = new Filme("Koe no Katachi","Romance","24.00","2016");
        estoque.put(filme, 3);
